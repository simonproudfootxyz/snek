...
export function GameHUD({ state }: GameHUDProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      ...
      <div className="rounded-lg border border-white/10 bg-white/5 p-3">
        <p className="text-xs uppercase tracking-wide text-white/55">Best</p>
      ...
      <div className="rounded-lg border border-white/10 bg-white/5 p-3">
        <p className="text-xs uppercase tracking-wide text-white/55">State</p>
        <p className="text-xl font-semibold capitalize text-white">{state.phase}</p>
      </div>
    </div>
  );
}
